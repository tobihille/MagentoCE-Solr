...
class DMC_Solr_Model_SolrServer_Adapter_Cms_Document extends DMC_Solr_Model_SolrServer_Document
{
	protected $_type = 'cms';
	...
	public function setObject($object)
	{
		try {
			...
			foreach ( DMC_Solr_Model_SolrServer_Adapter_Cms_TypeConverter::getStaticFields() as $key => $defaultValue ) {
