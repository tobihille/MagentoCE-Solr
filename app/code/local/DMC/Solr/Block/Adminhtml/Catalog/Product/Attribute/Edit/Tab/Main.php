...
class DMC_Solr_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('Solr_fieldset', array('legend'=>Mage::helper('catalog')->__('Solr Properties')));
